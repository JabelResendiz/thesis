...
\label{subsection:sistemas_autorreporte}
...
Tras esta evaluación, la base de datos FEDRA(Farmacovigilancia Española, Datos de Reacciones Adversas), sistema nacional de notificación y almacenamiento de sospechas de reacciones adversas a medicamentos, centraliza todos los registros del país \cite{aemps_fedra_2026}.
...
En contraste con el modelo ACID, algunas bases de datos adoptan el modelo BASE \cite{moniruzzaman2013nosql}:
...
\begin{table}[htbp]
	...
	\begin{tabular}{|p{3.2cm}|p{6.0cm}|p{6.0cm}|}
		\hline
	\textbf{Criterio} & \textbf{Relacional (SQL)} & \textbf{No Relacional (NoSQL)} \\[4pt]
	\hline
