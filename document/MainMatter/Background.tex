...
Con el objetivo de garantizar una selección fundamentada de las tecnologías que conformarán la solución propuesta, se establecen los siguientes criterios de evaluación:

En primer lugar, se considera la eficiencia y el rendimiento de las tecnologías, entendidos como la capacidad del sistema para responder de manera adecuada bajo cargas de trabajo variables y potencialmente elevadas. 
Este aspecto resulta especialmente relevante en sistemas de autorreporte clínico, donde la disponibilidad y rapidez de respuesta impactan directamente en la calidad del servicio.

En segundo lugar, se analiza la capacidad de escalabilidad, es decir, la posibilidad de que las tecnologías seleccionadas permitan el crecimiento del sistema sin requerir cambios estructurales significativos. 
Esto incluye tanto la escalabilidad vertical como horizontal, dependiendo del componente analizado.

Un tercer criterio corresponde a la mantenibilidad del sistema, entendida como la facilidad para realizar modificaciones, extensiones o correcciones en el software sin afectar negativamente su funcionamiento global. 
Este aspecto está directamente relacionado con la calidad de la arquitectura y el nivel de acoplamiento entre componentes.

Asimismo, se evalúa la madurez tecnológica y el soporte de las comunidades asociadas a cada herramienta, lo cual influye en la disponibilidad de documentación, librerías, actualizaciones y soluciones a problemas comunes.

Finalmente, se considera la adecuación al dominio del problema, es decir, la capacidad de la tecnología para ajustarse a los requerimientos específicos de un sistema orientado al manejo de información clínica, donde la consistencia de los datos y la trazabilidad de la información son aspectos fundamentales.

A partir de estos criterios, en las siguientes subsecciones se realiza un análisis comparativo de las principales alternativas tecnológicas para el desarrollo del backend, el frontend y los sistemas de gestión de bases de datos.
