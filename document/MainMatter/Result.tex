...
\begin{itemize}
    \item \textbf{Procesador:} Intel Core i7-1165G7 @ 2.80 GHz
...
\hline
CP07 & Finalización de revisión médica & Reporte en estado "En revisión" & Estado actualizado a "Revisado" & \checkmark \\
\hline
...
% Las figuras \ref{fig:reporte_exitoso} y \ref{fig:panel_asignaciones} muestran dos de los casos de prueba ejecutados: el registro exitoso de un reporte público y el panel de asignaciones del jefe de vacunación.

% \begin{figure}[H]
%     \centering
%     \includegraphics[width=0.85\textwidth]{Graphics/Cap5/reporte_exitoso.png}
%     \caption{CP01: Registro exitoso de un reporte público con número de notificación generado.}
%     \label{fig:reporte_exitoso}
% \end{figure}

% \begin{figure}[H]
%     \centering
%     \includegraphics[width=0.85\textwidth]{Graphics/Cap5/panel_asignaciones.png}
%     \caption{CP05: Panel de asignaciones del jefe de vacunación con reportes pendientes.}
%     \label{fig:panel_asignaciones}
% \end{figure}
