...
Durante el desarrollo de este trabajo, el autor empleó herramientas de inteligencia artificial generativa como asistentes en tareas de codificación, depuración y revisión de estilo. Modelos de lenguaje como ChatGPT y asistentes de código como GitHub Copilot sirvieron para acelerar la escritura de fragmentos repetitivos y mejorar la claridad de secciones del presente documento. El autor revisó y adaptó todo el código generado antes de incorporarlo al proyecto. La responsabilidad final sobre la corrección técnica, la originalidad del contenido y la validez de los resultados recae exclusivamente en el autor de este trabajo.