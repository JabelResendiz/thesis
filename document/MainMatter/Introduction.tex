...
Para comprender el alcance de la novedad, la Tabla \ref{tab:comparativa_novedad} contrasta la solución propuesta con el sistema actual en Cuba (FarmaVigiC) y referentes internacionales\footnote{Los referentes internacionales considerados (VAERS, NotificaRAM, entre otros) reciben un análisis en profundidad en el Capítulo \ref{chapter:state-of-the-art} (Sección \ref{section:analisis_sistemas_autorreporte}).}. 
