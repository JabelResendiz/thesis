...
En el lado del cliente opera la interfaz de usuario. 
...
En el lado del servidor opera la capa de servicios, que procesa las solicitudes del usuario, ejecuta la lógica de negocio y gestiona la persistencia de los datos. 
...
\begin{itemize}
	...
	\item Inyección de dependencias: patrón de diseño mediante el cual un objeto recibe sus dependencias desde el exterior en lugar de crearlas internamente.
\end{itemize}
...
\subsubsection{Comparación de los frameworks de frontend}
...
\subsubsection{Selección del framework de frontend}
