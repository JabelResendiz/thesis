...
\newglossaryentry{api}{
    name={API},
    description={Application Programming Interface (API): Conjunto de reglas, protocolos y herramientas que definen cómo distintos componentes de software deben interactuar entre sí. Una API establece los métodos, formatos de datos y convenciones que una aplicación expone para que otras puedan consumir sus funcionalidades sin necesidad de conocer su implementación interna}
}
