...
Panel informativo (E)  & 100 & 98 & \multirow{2}{*}{96} & \multirow{2}{*}{83} \\
Panel informativo (M)  & 95  & 95 & & \\ \hline
Consulta de reportes (E) & 100 & 93 & \multirow{2}{*}{100} & \multirow{2}{*}{91} \\
Consulta de reportes (M) & 94 & 93 & & \\ \hline
Gestión de reportes (E)  & 100 & 98 & \multirow{2}{*}{100} & \multirow{2}{*}{91} \\
Gestión de reportes (M)  & 96 & 92 & & \\ \hline
Gestión de médicos (E)   & 100 & 100 & \multirow{2}{*}{100} & \multirow{2}{*}{91} \\
Gestión de médicos (M)   & 90 & 94 & & \\ \hline
Gestión de jefes (E)     & 100 & 98 & \multirow{2}{*}{100} & \multirow{2}{*}{91} \\
Gestión de jefes (M)     & 99 & 93 & & \\ \hline
Gestión de catálogo (E)  & 100 & 94 & \multirow{2}{*}{100} & \multirow{2}{*}{91} \\
Gestión de catálogo (M)  & 95 & 94 & & \\ \hline
Dashboard municipal (E)  & 100 & 96 & \multirow{2}{*}{100} & \multirow{2}{*}{91} \\
Dashboard municipal (M)  & 96 & 91 & & \\ \hline
Inicio de sesión (E)     & 100 & 100 & \multirow{2}{*}{100} & \multirow{2}{*}{91} \\
Inicio de sesión (M)     & 97 & 94 & & \\ \hline
...
Consulta de reportes &
    ...
    \makecell{0.4 s \\ 2.5 s} &
    \makecell{0 ms \\ 30 ms} &
    \makecell{0.9 s \\ 4.1 s} &
    \makecell{0.002 \\ 0} \\
\hline
Gestión de reportes &
    \makecell{100 \\ 96} &
    ...
    \makecell{0 ms \\ 30 ms} &
    \makecell{0.7 s \\ 1.7 s} &
    \makecell{0.003 \\ 0} \\
\hline
Gestión de médicos &
    \makecell{100 \\ 90} &
    \makecell{0.4 s \\ 2.1 s} &
    \makecell{0.5 s \\ 3.0 s} &
    \makecell{20 ms \\ 50 ms} &
    \makecell{0.7 s \\ 4.5 s} &
    \makecell{0.003 \\ 0} \\
\hline
Gestión de jefes &
    \makecell{100 \\ 99} &
    \makecell{0.4 s \\ 1.7 s} &
    \makecell{0.4 s \\ 2.0 s} &
    \makecell{0 ms \\ 40 ms} &
    \makecell{0.6 s \\ 1.7 s} &
    \makecell{0.002 \\ 0} \\
\hline
...
Dashboard municipal &
    \makecell{100 \\ 96} &
    \makecell{0.4 s \\ 1.7 s} &
    \makecell{0.7 s \\ 2.6 s} &
    \makecell{0 ms \\ 0 ms} &
    \makecell{0.5 s \\ 1.7 s} &
    \makecell{0.014 \\ 0} \\
\hline
Inicio de sesión &
    \makecell{100 \\ 97} &
